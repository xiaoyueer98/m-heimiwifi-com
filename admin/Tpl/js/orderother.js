(function($){
      ...
      getData("get","json",{'page':1,'size':15},"admin.php?m=Order&a=getlist5",1);
...
function getCondition(page) {
      ...
      var tel = $("#tel").val();
      var size = $("#size").val();
      var data={'start_time':start_time,'end_time':end_time,'page':page,'size':size,'sta':sta,'title':title,'name':name,'tel':tel,'orderId':orderId};
      // 查询当前销售代表的客户列表
      getData("get", "json", data, "admin.php?m=Order&a=getlist5", page);
}
