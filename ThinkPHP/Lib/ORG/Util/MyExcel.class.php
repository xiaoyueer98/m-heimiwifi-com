...
class MyExcel
{
	...
	//require_once("/var/www/m-heimiwifi-com/ThinkPHP/Lib/ORG/Util/PHPExcel.class.php");
	...
	{
		$col_max = $this->_phpexcel->getSheet($this->_book)->getHighestColumn();
